...
const DARK_THEME_STYLE=`<style id="velnar-system-theme-v14">
...
function decorateHtml(res,isArticle){
  ...
  return res.text().then(text=>{
    ...
    if(!text.includes('velnar-sticky-brand-v14')){
